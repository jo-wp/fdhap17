...
import { ExternalLink, Button, __experimentalInputControl as InputControl, __experimentalInputControlPrefixWrapper as InputControlPrefixWrapper, __experimentalInputControlSuffixWrapper as InputControlSuffixWrapper, __experimentalVStack as VStack } from '@wordpress/components';
...
export default function PostURL({
  ...
  const postUrlSlugDescriptionId = 'editor-post-url__slug-descriotion-' + useInstanceId(PostURL);
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsx(InspectorPopoverHeader, {
      ...
      spacing: 3,
      children: [isEditable && /*#__PURE__*/_jsx("p", {
        className: "editor-post-url__intro",
        children: createInterpolateElement(__('<span>Customize the last part of the Permalink.</span> <a>Learn more.</a>'), {
