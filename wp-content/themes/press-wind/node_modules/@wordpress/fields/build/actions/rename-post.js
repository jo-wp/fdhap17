...
const renamePost = {
  ...
  isEligible(post) {
    ...
    if (![_utils.TEMPLATE_POST_TYPE, _utils.TEMPLATE_PART_POST_TYPE, ...Object.values(PATTERN_TYPES)].includes(post.type)) {
    ...
    if ((0, _utils.isTemplatePart)(post)) {
      return post.source === _utils.TEMPLATE_ORIGINS.custom && !post?.has_theme_file && post.permissions?.update;
    }
