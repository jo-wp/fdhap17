              ...
              success: {
                messages: {
                  getMessage: item => {
                    ...
                    (0, _i18n.__)('"%s" reset.'), (0, _htmlEntities.decodeEntities)((0, _utils.getItemTitle)(item))) : (0, _i18n.sprintf)(/* translators: The template/part's name. */
                    (0, _i18n.__)('"%s" deleted.'), (0, _htmlEntities.decodeEntities)((0, _utils.getItemTitle)(item)));
                  },
                  getBatchMessage: () => {
