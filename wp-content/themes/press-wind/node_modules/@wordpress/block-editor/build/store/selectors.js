 ...
 */
const __unstableGetEditorMode = exports.__unstableGetEditorMode = (0, _data.createRegistrySelector)(select => () => {
  return select(_preferences.store).get('core', 'editorTool');
});
