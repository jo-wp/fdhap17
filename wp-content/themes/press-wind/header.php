		...
		<header id="masthead" class="site-header">
            ...
            if ($mini_site) {
                ?>
                    ...
                    <section class="minisite-header mb-6 max-w-[914px] mx-auto flex justify-center items-end border-solid border-l-0 border-t-0 border-r-0 border-b-[2px] border-black/37 pb-3">
			...
			<?php
			if(is_singular('camping') || is_singular('post') || is_author()): 
			//ACF FIELDS
			$hero_type = get_field('hero_type');
			$activate_search = get_field('activate_search');
			$carousel_images = get_field('carousel_images');
			$firstCarousel = ($carousel_images)? $carousel_images[0] : '';
			$logo = get_field('logo');
			...
			switch ($hero_type) {
				...
				case 'little':
					...
					break;
				case 'tiny':
					$arrow_menu = 'bg-arrow-menu-black';
			...
			<section class="block-hero w-full">
				...
				<div
					...
					<div
						class="md:hidden block-hero__content__mobile bg-white px-[15px] flex flex-row justify-between items-center">
	...
	max-md:transition-transform max-md:duration-300 max-md:ease-in-out">
				...
				max-md:flex-col max-md:justify-start max-md:items-start max-md:ml-[15px]">
						...
						max-md:before:right-[20px]">
									<a href="#"
										class=" <?= $text_color; ?> max-md:font-[700] text-[16px] relative block font-arial hover:no-underline after:content-[''] after:<?= $arrow_menu; ?> after:w-[12px] after:h-[7px] after:block after:absolute after:-right-[20px] after:top-[45%] ">Trouver
										son camping</a>
						...
						max-md:leading-[initial] max-md:py-[15px] max-md:w-full max-md:border-t-0 max-md:border-l-0 max-md:border-r-0 max-md:border-b max-md:border-black/10 max-md:border-solid">
									<a href="#"
										class="<?= $text_color; ?> max-md:font-[700] text-[16px] relative  block font-arial hover:no-underline after:content-[''] after:<?= $arrow_menu; ?> after:w-[12px] after:h-[7px] after:block after:absolute after:-right-[20px] after:top-[45%] ">Vos
										envies</a>
								</li>
								<li class=" relative leading-[90px] after:w-0 after:transition-all after:duration-300 after:content-[''] hover:after:absolute hover:after:left-0 hover:after:-bottom-[2px] hover:after:content-[''] hover:after:w-[100%] hover:after:h-[3px] hover:after:bg-orange
						max-md:leading-[initial] max-md:py-[15px] max-md:w-full max-md:border-t-0 max-md:border-l-0 max-md:border-r-0 max-md:border-b max-md:border-black/10 max-md:border-solid
						...
						max-md:before:right-[20px]">
									<a href="#"
										class="<?= $text_color; ?> max-md:font-[700] text-[16px] relative  block font-arial hover:no-underline after:content-[''] after:<?= $arrow_menu; ?> after:w-[12px] after:h-[7px] after:block after:absolute after:-right-[20px] after:top-[45%] ">Votre
										façon de camper</a>
								</li>
								<li class=" relative leading-[90px] after:w-0 after:transition-all after:duration-300 after:content-[''] hover:after:absolute hover:after:left-0 hover:after:-bottom-[2px] hover:after:content-[''] hover:after:w-[100%] hover:after:h-[3px] hover:after:bg-orange
						max-md:leading-[initial] max-md:py-[15px] max-md:w-full max-md:border-t-0 max-md:border-l-0 max-md:border-r-0 max-md:border-b max-md:border-black/10 max-md:border-solid
						...
						max-md:before:right-[20px]">
									<a href="#"
										class="<?= $text_color; ?> max-md:font-[700]  text-[16px] relative  block font-arial hover:no-underline after:content-[''] after:<?= $arrow_menu; ?> after:w-[12px] after:h-[7px] after:block after:absolute after:-right-[20px] after:top-[45%] ">Explorer
						...
						max-md:before:right-[20px]">
									<a href="#"
										class="<?= $text_color; ?> max-md:font-[700]  text-[16px] relative  block font-arial hover:no-underline after:content-[''] after:<?= $arrow_menu; ?> after:w-[12px] after:h-[7px] after:block after:absolute after:-right-[20px] after:top-[45%] ">Nos
										offres spéciales</a>
								</li>
							</ul>
						</nav>
					...
					<?php if ($hero_type == 'full'): ?>
						<div
							...
							<h1
								class="text-white mb-[40px]">
								Trouvez votre camping<br>en Charente Maritime</h1>
							<div class="block-hero__content__carousel flex flex-row gap-[28px]">
