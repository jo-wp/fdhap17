  ...
  <div class="flex <?= $section_class; ?> flex-wrap md:gap-[90px]  mx-auto ">
    ...
    <div class="flex-1 <?= $block_texte_class; ?>  max-md:px-[15px] md:pr-[100px]">
      <InnerBlocks
        ...
        [&_h2]:font-[600] [&_h2]:font-ivymode [&_h2_span]:font-arial [&_h2_sub]:font-arial [&_h2_sub]:font-[400]
         max-md:[&_h2]:text-center [&_h2_span]:text-[20px] md:[&_h2_span]:text-[32px] [&_h2_sub]:text-[24px] 
         md:[&_h2_sub]:text-[32px]"
