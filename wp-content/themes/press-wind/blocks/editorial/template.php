...
switch ($type_block_editorial) {
	case 'default':
        ...
        $class_innerblock = '[&_p]:text-left [&_h2]:text-left [&_h1]:text-left  mb-[40px] [&_h2]:mb-[50px] [&_h1]:mb-[50px]';
...
<section <?= get_block_wrapper_attributes(["class" => 'block-editorial '.$size_section.' mx-auto '.$class_block_editorial.'   justify-between items-center']); ?>>
  <div class="<?= $size_blocks_content; ?> <?= $class_block_editorial_texte; ?>" >
      <InnerBlocks class="<?php echo $class_innerblock; ?> md:[&_p]:text-inherit md:[&_h2]:text-inherit md:[&_h1]:text-inherit [&_h2_sub]:text-center [&_h1_sub]:text-center md:[&_h2_sub]:text-inherit md:[&_h1_sub]:text-inherit text-[14px] md:[&_p]:text-[15px] [&_h2]:font-[600] [&_h1]:font-[600] [&_h2]:text-[24px] [&_h1]:text-[24px] md:[&_h2]:text-[32px] md:[&_h1]:text-[32px] [&_h2_sub]:font-arial [&_h1_sub]:font-arial [&_h2_sub]:text-[24px] [&_h1_sub]:text-[24px] md:[&_h2_sub]:text-[32px] md:[&_h1_sub]:text-[32px] [&_h2_sub]:float-none [&_h1_sub]:float-none  md:[&_h2_sub]:float-right md:[&_h1_sub]:float-right [&_h2_sub]:font-[400] [&_h1_sub]:font-[400] [&_h2]:font-[400] [&_h1]:font-[400] [&_p]:font-arial" template="<?php echo esc_attr(wp_json_encode($template)) ?>"
