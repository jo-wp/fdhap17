...
switch ($type_block_editorial) {
	case 'default':
        ...
        $class_innerblock = 'mb-[40px] [&_h2]:mb-[50px]';
	...
	case 'image_big_right':
		...
		break;
    case 'image_big_btn':
        $size_section = 'max-w-[1270px]';
        $size_blocks_content = 'max-md:w-full md:w-[52%] ';
        $size_blocks_image = 'max-md:w-full md:w-[65%] ';
        $class_innerblock = 'mb-0 [&_h2]:mb-[35px]';
        $size_image = 'w-full h-full object-cover object-center';
        $class_block_editorial_texte = '-ml-[17%] bg-white px-[45px] py-[70px] rounded-[10px] shadow-[1px_8px_30px_0_rgba(186,186,186,0.18)]';
        $class_block_editorial = 'flex max-md:flex-col md:flex-row-reverse ';
        break;
