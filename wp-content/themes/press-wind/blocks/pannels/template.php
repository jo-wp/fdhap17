...
<section <?= get_block_wrapper_attributes(["class" => 'block-pannels max-w-[1066px] mx-auto flex flex-col flex-wrap']); ?>>
  <div>
    <InnerBlocks
      class=" [&_h2]:text-black [&_h2_sub]:text-black [&_p]:m-0 [&_p]:text-[20px] md:[&_p]:text-[32px] [&_p]:font-[400] [&_p]:text-black [&_p]:font-arial [&_h2]:text-[20px] [&_h2_sub]:text-[20px] md:[&_h2]:text-[36px] md:[&_h2_sub]:text-[36px] [&_h2]:font-[700] [&_h2_sub]:font-[700] [&_h2]:font-ivymode [&_h2_sub]:font-arial"
