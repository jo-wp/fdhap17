...
if($content_one_col) {
    ...
    $class = 'max-w-[1280px] flex max-md:flex-col md:flex-row flex-wrap justify-between items-start md:gap-[70px]';
    $class_container = "flex-1 md:max-w-[40%]";
    $class_text = "mb-[40px] after-underline";
}


?>
<section <?= get_block_wrapper_attributes(["class" => 'block-editorial-text  mx-auto max-[1280px]:mx-[30px] '.$class.' ']); ?>>
