          ...
          <div class="splide__track">
            <ul class="splide__list max-md:!grid max-md:!grid-cols-2 max-md:!gap-[10px]">
              ...
              <li class="splide__slide splide__slide-item max-md:min-h-[200px] animateFade fadeOutAnimation" data-taxonomie="<?= $item['filter-title']; ?>">
                <div
                  class=" max-md:shadow-md min-h-full bg-cover  after:content-[''] rounded-[10px] after:rounded-[10px] after:absolute after:left-0 after:bottom-0 after:w-full after:h-[50%] after:bg-gradient-to-b after:from-transparent after:to-[#00000066] rounded-[10px] flex flex-row justify-start items-end md:pl-5 md:pb-5"
